...
class Flickr
{
  ...
  protected $upload_endpoint = 'https://api.flickr.com/services/upload/';
  protected $replace_endpoint = 'https://api.flickr.com/services/replace/';
  protected $oauthrequest_endpoint = 'https://www.flickr.com/services/oauth/request_token/';
  protected $oauthauthorize_endpoint = 'https://www.flickr.com/services/oauth/authorize/';
  protected $oauthaccesstoken_endpoint = 'https://www.flickr.com/services/oauth/access_token/';
  protected $req;
  protected $response;
  ...
  public function Flickr($api_key, $secret = null, $die_on_error = false)
  {
    // The API Key must be set before any calls can be made.  You can
    // get your own at http://www.flickr.com/services/api/misc.api_keys.html
    // or if you already have one go to "Apps by You" at https://www.flickr.com/services/
  ...
  function buildPathToPhoto($photo)
  {
  ...
  function buildPhotoURL($photo, $size = 'medium')
  {
    ...
    $sizes = array(
      ...
      'thumbnail' => '_t',  // 100 on the longest side
      'small' => '_m',  // 240 on the longest side
      'small_320' => '_n',  // 320 on the longest side 
      'medium' => '',    // 500 on the longest side
      'medium_640' => '_z',  // 640 on the longest side
      'medium_800' => '_c',  // 800 on the longest side
      'large' => '_b',  // 1240 on the longest side
      'large_1600' => '_h',  // 1600 on the longest side
      'large_2048' => '_k',  // 2048 on the longest side
      'original' => '_o'   // either a jpg, gif or png, depending on source format
    );

    $size = strtolower($size);

    $size = !array_key_exists($size, $sizes) ? 'medium' : $size;
